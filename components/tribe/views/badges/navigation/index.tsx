...
const Sidebar = ({
  ...
  return (
    <nav className="flex-1 flex flex-col min-h-0 h-full bg-sapien-neutral-600">
      ...
      <div className="overflow-auto mt-2 px-4">
        <button
      ...
      <div className="border-t-[1px] border-sapien-neutral-200 mt-1" />
      <div className="px-4 py-3">
        <button
          onClick={showSearch}
          type="button"
          className="w-full text-gray-300 group px-3 py-2 cursor-pointer rounded-lg flex items-center justify-between text-base font-medium bg-gray-700 hover:bg-gray-50 hover:text-gray-900"
        >
