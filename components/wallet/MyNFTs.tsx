    ...
    <div>
      <div className={tw`flex w-full h-96 absolute`}>
        <Transition
          ...
          enterFrom={tw`${
            prevStep > MyNFTsSteps.BadgesList
              ? '-translate-x-full'
              : 'translate-x-full'
          }`}
        ...
        <Transition
          appear
          show={step === MyNFTsSteps.ReceiversList}
          as={Fragment}
          enter={tw`transition ease-in-out duration-300 transform`}
          enterFrom={tw`${
            prevStep > MyNFTsSteps.ReceiversList
              ? '-translate-x-full'
              : 'translate-x-full'
          }`}
          enterTo={tw`translate-x-0`}
          leave={tw`transition ease-in-out duration-300 transform`}
          leaveTo={tw`${
            step < MyNFTsSteps.ReceiversList
              ? 'translate-x-full'
              : '-translate-x-full'
          }`}
          leaveFrom={tw`translate-x-0`}
        ...
        <Transition
          appear
          show={step === MyNFTsSteps.Confirmation}
          as={Fragment}
          enter={tw`transition ease-in-out duration-300 transform`}
