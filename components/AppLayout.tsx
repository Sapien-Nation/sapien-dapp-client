                  ...
                  <div className={tw`flex-shrink-0 hidden lg:flex`}>
                    ...
                    >
                      <div>
                        ...
                        >
                          <Menu.Items
                            className={tw`z-100 w-96 mx-3 origin-top absolute bottom-16 right-0 left-0 mt-1 rounded-xl shadow-2xl bg-white divide-y divide-gray-200 focus:outline-none`}
                          >
